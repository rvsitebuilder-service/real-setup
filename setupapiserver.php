...
if (isset($_GET['homeuser'])) {
    $homeuser       = $_GET['homeuser'];
}
if (isset($_GET['domainname'])) {
    $domainname     = $_GET['domainname'];
}
if (isset($_GET['publicpath'])) {
    $publicpath     = $_GET['publicpath'];
}
...
if (isset($_GET['adminfirstname'])) {
    $adminfirstname = $_GET['adminfirstname'];
}
if (isset($_GET['adminlastname'])) {
    $adminlastname  = $_GET['adminlastname'];
}
if (isset($_GET['domainport'])) {
    $domainport     = $_GET['domainport'];
}
if (isset($_GET['artisancmd'])) {
    $artisancmd     = $_GET['artisancmd'];
}
if (isset($_GET['artisanparam'])) {
    $artisanparam   = $_GET['artisanparam'];
}
if (isset($_GET['additionalpkg'])) {
    $additionalpkg  = $_GET['additionalpkg'];
}
if (isset($_GET['welcomeemailtype'])) {
    $welcomeemailtype  = $_GET['welcomeemailtype'];
}
if (isset($_GET['isrepair'])) {
    $isrepair  = $_GET['isrepair'];
}
if (isset($_GET['cptype'])) {
    $cptype  = $_GET['cptype'];
}
...
if (isset($_POST['homeuser'])) {
    $homeuser       = $_POST['homeuser'];
}
if (isset($_POST['domainname'])) {
    $domainname     = $_POST['domainname'];
}
if (isset($_POST['publicpath'])) {
...
if (isset($_POST['adminlastname'])) {
    $adminlastname  = $_POST['adminlastname'];
}
if (isset($_POST['domainport'])) {
    $domainport     = $_POST['domainport'];
}
if (isset($_POST['artisancmd'])) {
    $artisancmd     = $_POST['artisancmd'];
}
if (isset($_POST['artisanparam'])) {
    $artisanparam   = $_POST['artisanparam'];
}
if (isset($_POST['additionalpkg'])) {
    $additionalpkg  = $_POST['additionalpkg'];
}
if (isset($_POST['welcomeemailtype'])) {
    $welcomeemailtype  = $_POST['welcomeemailtype'];
}
if (isset($_POST['isrepair'])) {
    $isrepair  = $_POST['isrepair'];
}
if (isset($_POST['cptype'])) {
    $cptype  = $_POST['cptype'];
}
...
class FTP_Handler
{
    ...
    public function connect($ftpserver)
    {
        $result = [];
        $result['success'] = 1;
    ...
    public function put($source = '', $dest = '', $mode = 'FTP_ASCII')
    {
        $result = [];
        $result['success'] = 1;
    ...
    public function ftp_change_mod($path, $perm=0777)
    {
        ftp_chmod($this->conn_id, $perm, $path);
        return true;
    }
